...
from src.mlproj.utils import save_object
import os
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            logging.info("Preprocessor object has been called.")
            ...
            logging.info("numericaal columns:{numerical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            #divide dataset to independent and dependent feature
